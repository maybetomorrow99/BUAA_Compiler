...
li $t0, 1
sw $t0, -216($fp)
#ADD, $temp59, $temp60, $temp59
lw $t0, -212($fp)
lw $t1, -216($fp)
add $t0, $t0, $t1
sw $t0, -212($fp)
#LVAR, $temp59, , var_int_2
lw $t0, -212($fp)
la $t1, var_int_2
sw $t0, 0($t1)
#LVAR, var_int_2, , $temp61
la $t1, var_int_2
lw $t0, 0($t1)
sw $t0, -220($fp)
#PRT, 0, , $temp61
...
#VOF, test_if, , $temp65
sw $v0, -180($fp)
#LVAR, $temp65, , var_char_res
lw $t0, -180($fp)
move $t6, $t0
#LVAR, var_char_res, , $temp68
move $t0, $t6
sw $t0, -184($fp)
#PRT, 0, , $temp68
li $v0, 11
...
#VOF, test_if, , $temp69
sw $v0, -196($fp)
#LVAR, $temp69, , var_char_res
lw $t0, -196($fp)
move $t6, $t0
#LVAR, var_char_res, , $temp72
move $t0, $t6
sw $t0, -200($fp)
#PRT, 0, , $temp72
li $v0, 11
...
lw $fp ,-124($sp)
lw $ra ,-128($sp)
#VOF, test_factorial, , $temp73
sw $v0, -208($fp)
#LVAR, $temp73, , var_int_res
lw $t0, -208($fp)
move $t5, $t0
...
lw $fp ,-120($sp)
lw $ra ,-124($sp)
#VOF, test_while, , $temp77
sw $v0, -220($fp)
#LVAR, $temp77, , var_int_res
lw $t0, -220($fp)
move $t5, $t0
#LVAR, var_int_res, , $temp78
move $t0, $t5
sw $t0, -224($fp)
#PRT, 0, , $temp78
li $v0, 1
